        ...
        try {
            ResourcesPlugin.getWorkspace().run(new IWorkspaceRunnable()
            {
                public void run(IProgressMonitor monitor) throws CoreException
                {
                    ...
                    /* Write the page */
                    StorageUtils.writeDataToXML(baseFolder.getFolder(PAGES_DIRECTORY).getFile(
            ...
            ResourcesPlugin.getWorkspace().run(new IWorkspaceRunnable()
            {
                public void run(IProgressMonitor monitor) throws CoreException
                {
                    try {
                        ...
                        /* Write the object */
                        StorageUtils.writeDataToXML(baseFolder.getFolder(OBJECTS_DIRECTORY).getFile(
    ...
    public void storeClass(final XWikiClass xwikiClass) throws XWikiEclipseStorageException
    {
        try {
            ResourcesPlugin.getWorkspace().run(new IWorkspaceRunnable()
            {
                public void run(IProgressMonitor monitor) throws CoreException
                {
                    StorageUtils.writeDataToXML(baseFolder.getFolder(CLASSES_DIRECTORY).getFile(
