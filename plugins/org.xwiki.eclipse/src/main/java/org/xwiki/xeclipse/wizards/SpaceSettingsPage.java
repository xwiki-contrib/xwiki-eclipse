...
public class SpaceSettingsPage extends WizardPage
{
    ...
    public void createControl(Composite parent)
    {
        ...
        GridDataFactory.fillDefaults().align(SWT.FILL, SWT.FILL).grab(true, true).applyTo(spaceSettingsArea);
    ...
    private Composite createSpaceSettingsArea(Composite parent) {
        ...
        GridDataFactory.fillDefaults().align(SWT.FILL, SWT.FILL).grab(true, true).applyTo(descriptionText);
