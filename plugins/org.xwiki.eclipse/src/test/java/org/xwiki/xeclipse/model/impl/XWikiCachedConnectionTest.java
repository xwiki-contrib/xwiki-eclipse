...
public class XWikiCachedConnectionTest
{
    ...
    {
        connection = new XWikiCachedConnection(Constants.SERVER_URL, Constants.USERNAME, new File(Constants.CACHE_DIR));
    ...
    /*
     * This test retrieves all the pages of the first remote space and checks that they are correctly cached.
     */
    @Test
    ...
    /*
     * This test retrieve a page, modify it locally, synchronize with the server and checks
     * that the page contents are the same.
     */
    @Test
    ...
    /*
     * This test simulates a concurrent local/remote  modification that generates a conflict, and its resolution.    
     */
    @Test 
    public void conflictTest() throws XWikiConnectionException, XWikiDAOException {
        //Create a "parallel" connection.
        XWikiRemoteDAO remoteDAO = new XWikiRemoteDAO("http://localhost:8080/xwiki/xmlrpc/confluence", "test", "test");
