 ...
 * @version $Id$
 */
public class XWikiEclipseClassPropertiesPage extends PropertyPage
{

    public XWikiEclipseClassPropertiesPage()
    {
        super();
    }
    ...
    protected Control createContents(Composite parent)
    {
        ...
        XWikiEclipseClass clazz = (XWikiEclipseClass) getElement().getAdapter(XWikiEclipseClass.class);

        Label property = new Label(composite, SWT.NONE);
        property.setText("ID:");
        Label value = new Label(composite, SWT.NONE);
        value.setText(clazz.getId());

        property = new Label(composite, SWT.NONE);
        property.setText("URL:");
        Link link = new Link(composite, SWT.NONE);

        link.setText(clazz.getUrl() == null ? "" : String.format("<a>%s</a>", clazz.getUrl()));
